...
to-report get_mod_distance [a b]
  ...
  report ([myid] of b - [myid] of a) mod 10000
...
to go
  ...
  ask turtles[
    ...
    [
      ...
      [
        if (get_mod_distance self ? > get_mod_distance self mySucessor) [
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot changes"
...
197
force circle
layout-circle sort-by [[myId] of ?1 < [myId] of ?2] turtles (max-pxcor - 2)
NIL
1
T
OBSERVER
